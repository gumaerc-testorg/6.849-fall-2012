...
---
Students are asked to view the relevant lecture videos, recorded in Fall 2010, prior to attending each class. The lecture videos and class videos correspond numerically (e.g., Lecture 1 before Class 1, Lecture 2 before Class 2, and so on). The lecture and class session videos are also available in an integrated format (synced notes, slides, and video) on {{% resource_link "2b0416c3-1a03-4fd9-ba5a-aa9c5b95d7ac" "Prof. Demaine’s website for this course" %}}.